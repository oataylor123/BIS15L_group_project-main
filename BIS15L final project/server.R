  ...
  function(input, output, session){    
    ...
    output$totalEarned_text = renderText({
      ...
      isolate({
        ...
        labpresentationGrades = userGrades()[[4]]
        labpresentation8Grades = userGrades()[[5]]
        midtermGrades = userGrades()[[6]]
        ...
        str1 = paste("Before lowest lab dropped, total points earned (out of 500", totalWorthSoFar, ") are: ", totalGradeSoFar, 
