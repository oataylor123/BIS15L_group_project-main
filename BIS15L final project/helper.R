...
labpresentationWorth = rep(5, 2); names(labpresentationWorth) = paste("LABPRESENTATION", 4:5, sep="")
labpresentation8Worth = 15; names(labpresentation8Worth) = "LABPRESENTATION"
labpracticalWorth = 45; names(labpracticalWorth) = "LABPRACTICAL"
midtermWorth = rep(90, 3); names(midtermWorth) = "MIDTERM"
...
PlotGrades = function(quizWorth,  labWorth,  labpracticalWorth, labpresentationWorth, labpresentation8Worth, midtermWorth){
  ...
  polygon(c(1, xLen+0.5, xLen+0.5, 1), c(yLowLimit, yLowLimit, 90, 90), col="darkseagreen4")
  polygon(c(1, xLen+0.5, xLen+0.5, 1), c(70, 70, 90, 90), col="skyblue3")
  polygon(c(1, xLen+0.5, xLen+0.5, 1), c(90, 90, 100, 100), col="khaki2")
